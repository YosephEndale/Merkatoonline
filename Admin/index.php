  ...
  <a class="nav-link text-white" href="pages/profile.php">
      ...
      <span class="nav-link-text ms-1">Profile Management</span>
          ...
          <!-- Dashboard -->
            ...
            <!-- User Management -->
            <li class="nav-item">
                <a class="nav-link text-white" href="pages/User_Management.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- Order Management -->
            <li class="nav-item">
                <a class="nav-link text-white" href="pages/Order_Management.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- Category Management -->
            <li class="nav-item">
                <a class="nav-link text-white" href="pages/Category_Management.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- Product Management -->
            <li class="nav-item">
                <a class="nav-link text-white" href="pages/Product_Management.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- Report Management -->
            <li class="nav-item">
                <a class="nav-link text-white" href="pages/Report_Management.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <!-- Settings -->
<li class="nav-item">
  <a class="nav-link text-white" href="pages/Settings.php">
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
